...
import Footer from '../../components/MOLEKUL/Footer'; // Pastikan path ke Footer benar
          ...
          {improvementAreas.map((area, index) => (
            <View key={index} style={styles.improvementArea}>
              ...
              <View style={styles.tableHeader}>
                <Image
                  source={require('../../assets/questionmark.png')} // Ganti dengan path ikon trending up Anda
                  style={styles.rateIcon}
                  resizeMode="contain"
                />
                <Text style={[styles.headerCell, {flex: 2}]}>Question</Text>
                <Image
                  source={require('../../assets/checklist.jpg')} // Ganti dengan path ikon checkmark Anda
